...
public class ShoppingCart {
     ...
     * incremented.
     *
     * @param book the <code>Book</code> that defines the type of shopping cart item
    ...
    public synchronized void addItem(Book book) {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            if (Objects.equals(scItem.getBook().getId(), book.getId())) {
    ...
    /**
     * Increments the quantity of the specified book. Does nothing
     * if the quantity is already 10 or more, or if the book is not 
     * in the cart.
     * 
     * @param book the book to increment the quantity of 
     */
    ...
    /**
     * Decrements the quantity of the specified book. Removes the book
     * from the cart if the quantity is less than 1.
     * Does nothing if the book is not found in the cart.
     * 
     * @param book the book to decrement the quantity of
     */
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            amount += (scItem.getQuantity() * book.getPrice().doubleValue());
        }
