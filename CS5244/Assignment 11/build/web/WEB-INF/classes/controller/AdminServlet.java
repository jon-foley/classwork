...
/**
 *Servlet to handle administrative requests
 * 
 * @author jfoley
 */
...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Admin servlet initial path: " + userPath);
        ...
        if (userPath.equals("/admin/logout")) {
            ...
            response.sendRedirect("/BookDepot/admin/");
            return;
        }

        // use RequestDispatcher to forward request internally
        userPath = "/admin/index.jsp";
        System.out.println("Admin servlet final path: " + userPath);
        try {
